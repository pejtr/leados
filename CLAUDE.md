# OPTIHUB — AI Lead Generation & CRM Platform

## Project Overview

OPTIHUB is a full-stack AI-powered lead generation and sales CRM platform. It generates B2B leads via LinkedIn/Xing scraping (Apify), enriches them with AI icebreakers, and provides a complete sales pipeline with CRM, sequences, analytics, and a multi-agent AI orchestrator (HERMES).
