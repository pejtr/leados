    ...
    <DashboardLayout>
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        <div>
          ...
          <p className="text-white/40 mt-1 text-sm">Propoj OPTIHUB s externími nástroji a platformami.</p>
        </div>
        ...
        <Tabs defaultValue="integrations">
          ...
          <TabsContent value="docs" className="mt-6 space-y-4">
            <div className="rounded-xl border border-white/5 bg-white/[0.02] p-5 space-y-4">
              <div>
                <h3 className="text-sm font-semibold text-white mb-1">OPTIHUB REST API</h3>
              ...
              <div className="rounded-lg bg-black/40 border border-white/5 p-3 space-y-2">
                ...
                <code className="text-xs text-purple-300 font-mono">X-OPTIHUB-Signature: sha256=HMAC_SHA256(secret, body)</code>
              </div>
            </div>
          </TabsContent>
        </Tabs>
