    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="bg-zinc-800/60 rounded-xl p-5 flex flex-col justify-between">
        <div className="space-y-3">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-zinc-400">Náklady na OPTIHUB</span>
...
export default function Billing() {
  ...
  if (success) {
    toast.success(t("billing.subscriptionActivated", "Předplatné aktivováno! Vítejte v OPTIHUB."));
    refetch();
  ...
  return (
    <DashboardLayout>
      <div className="p-6 max-w-6xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          <div className="relative rounded-2xl border border-zinc-600/40 bg-gradient-to-b from-zinc-800/40 to-zinc-900/20 p-5 flex flex-col">
            ...
            <Button
              ...
              onClick={() => window.open("mailto:sales@crmleads.io?subject=OPTIHUB Enterprise", "_blank")}
            >
        ...
        <div>
          <h2 className="text-lg font-semibold text-white mb-4">{t("billing.comparisonTitle", "OPTIHUB vs. konkurence")}</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-700/50 bg-zinc-800/50">
                  ...
                  <th className="text-center py-3 px-4 text-violet-400 font-bold">OPTIHUB</th>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-r from-violet-600/20 to-blue-600/10 border border-violet-500/20 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="text-white font-semibold text-lg">{t("billing.demoTitle", "Chcete vidět OPTIHUB v akci?")}</h3>
            <p className="text-zinc-400 text-sm mt-1">{t("billing.demoSubtitle", "Naplánujte si 30minutové demo s naším týmem a uvidíte, jak OPTIHUB transformuje váš B2B pipeline.")}</p>
          </div>
          <Button
            className="gap-2 bg-violet-600 hover:bg-violet-700 text-white shrink-0"
            onClick={() => window.open("mailto:sales@crmleads.io?subject=OPTIHUB Demo Request", "_blank")}
          >
