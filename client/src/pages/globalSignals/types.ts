 ...
 *   likely      — reported by credible source, cross-reference pending
 *   unverified  — OSINT lead, single source, treat with caution
 */
...
export interface GlobalSignal {
    ...
    mitreAttackId?: string; // for cyber threats
}
