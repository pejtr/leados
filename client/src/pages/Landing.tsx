          ...
          <Reveal>
            <div className="text-center mb-12">
              ...
              <p className="text-lg max-w-2xl mx-auto" style={{ color: C.textMuted }}>
                Filter by your industry to see how OPTIHUB performs for businesses like yours.
              </p>
            </div>
          </Reveal>
                ...
                <div className="relative rounded-3xl p-6"
                  ...
                  <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-semibold" style={{ color: C.textMuted }}>OPTIHUB Quality Report</span>
                    </div>
      ...
      <section className="py-16 px-4 sm:px-6" style={{ background: "#f0f4ff", borderTop: `1px solid ${C.border}` }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { name: "Tomáš Novotný", role: "VP Sales, Pražský SaaS s.r.o.", flag: "CZ", text: "OPTIHUB ztrojnásobil naši outbound pipeline za 3 týdny. Soulad s GDPR byl klíčový pro naše enterprise klienty.", metric: "3× Pipeline", metricLabel: "za 3 týdny" },
              ...
              { name: "Marek Zimmermann", role: "CEO, Praha FinTech Startup", flag: "CZ", text: "Uzavřeli jsme 3 enterprise obchody v prvním měsíci s OPTIHUB. ROI byl pozitivní hned od začátku.", metric: "3 Enterprise", metricLabel: "1. měsíc" },
        ...
        <div className="max-w-5xl mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              ...
              <p className="text-lg" style={{ color: C.textMuted }}>Podívejte se, co přesně se změní, když nahradíte ruční vyhledávání automatizací OPTIHUB.</p>
            </div>
          </Reveal>
            ...
            <Reveal delay={0.1}>
              <div className="rounded-2xl p-6" style={{ background: `linear-gradient(160deg, ${C.teal}0d, ${C.indigo}0a)`, border: `1px solid ${C.teal}30` }}>
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <span className="font-bold text-sm" style={{ color: C.tealDark }}>PO — OPTIHUB AI automatizace</span>
                </div>
                <ul className="space-y-3">
                  {[
                    ...
                    "💰 ROI: 1 uzavřený obchod zaplatí 12 měsíců OPTIHUB",
                  ].map(item => (
          ...
          <Reveal delay={0.2}>
            <div className="mt-8 p-5 rounded-2xl text-center" style={{ background: `linear-gradient(135deg, ${C.indigo}08, ${C.teal}06)`, border: `1px solid ${C.indigo}20` }}>
              <p className="text-sm font-medium mb-1" style={{ color: C.text }}>💡 Rychlý ROI: Pokud je vaše průměrná zakázka <strong>150 000 Kč</strong> a OPTIHUB vám pomůže uzavřít jen <strong>1 obchod navíc/měsíc</strong></p>
                  ...
                  <thead>
                    <tr style={{ background: `${C.indigo}08`, borderBottom: `1px solid ${C.border}` }}>
                      ...
                      <th className="px-5 py-4 font-bold text-center" style={{ background: `${C.indigo}06` }}>
                        <span style={{ background: `linear-gradient(135deg, ${C.indigo}, ${C.teal})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontFamily: "'Space Grotesk', sans-serif" }}>OPTIHUB</span>
                      </th>
      ...
      <footer className="pt-16 pb-10 px-4 sm:px-6" style={{ borderTop: `1px solid ${C.border}`, background: C.bgCard }}>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6"
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold" style={{ fontFamily: "'Space Grotesk', sans-serif", color: C.text }}>OPTIHUB</span>
          </div>
          <div className="flex items-center gap-6 text-sm" style={{ color: C.textMuted }}>
            <a href="#features" className="hover:text-indigo-600 transition-colors">{t("nav.features")}</a>
            <a href="#case-studies" className="hover:text-indigo-600 transition-colors">{t("nav.results")}</a>
            <a href="#pricing" className="hover:text-indigo-600 transition-colors">{t("nav.pricing")}</a>
            <span>© 2026 OPTIHUB</span>
          </div>
