  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
      ...
      <section className="py-16 px-4 border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/40 mb-8">
            OPTIMATEO integruje tyto asistenty přímo do vašeho webu nebo Telegram kanálu.
      ...
      <footer className="py-8 text-center text-white/20 text-sm border-t border-white/5">
        © {new Date().getFullYear()} OPTIMATEO · <a href="/agents" className="text-violet-400 hover:text-violet-300">AI Agenti</a>
      </footer>
    </div>
  );
}
