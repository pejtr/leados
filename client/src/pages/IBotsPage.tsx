  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="/agents">
              <Button className="bg-amber-500 hover:bg-amber-600 text-black font-bold px-8 py-3 rounded-full text-base shadow-[0_0_30px_rgba(245,158,11,0.3)]">
                Vyzkoušet AI Agenty ONYXO <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
            </a>
            <a href="/#pricing">
      ...
      <section className="py-16 px-4 border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/40 mb-8">
            ONYXO integruje tyto AI osobnosti přímo do vašeho webu nebo Telegram kanálu.
      ...
      <footer className="py-8 text-center text-white/20 text-sm border-t border-white/5">
        © {new Date().getFullYear()} ONYXO · <a href="/agents" className="text-violet-400 hover:text-violet-300">AI Agenti</a>
      </footer>
    </div>
  );
}
