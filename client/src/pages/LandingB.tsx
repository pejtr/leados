    ...
    <div className="min-h-screen bg-[#030308] text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight">Onyx OS</span>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <p className="text-white/40 text-sm sm:text-lg mb-8">Join 500+ B2B teams already using Onyx OS to crush their quotas.</p>
          <Button
            size="lg"
      ...
      <footer className="py-8 sm:py-10 px-4 sm:px-6 border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-6xl mx-auto flex flex-col gap-4 sm:gap-0 sm:flex-row items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm">Onyx OS</span>
          </div>
          <p className="text-xs text-white/30">© 2026 Onyx OS. All rights reserved.</p>
