...
import {
  ...
  TrendingUp, Trophy, Link2, Megaphone, FileBarChart, Scroll, FlaskConical, Sparkles, Moon, Sun,
...
const dockItems = [
  ...
  { icon: Sun, path: "/daily-routines", label: "Daily Routines", color: "oklch(0.70 0.22 60)", desc: "Ranní briefing — přehled dne v jednom pohledu" },
];
...
const allMenuItems = [
  ...
  { icon: Radio, labelKey: "sidebar.globalSignalDesk", path: "/global-signal-desk", group: "intelligence" },
  ...
  { icon: Sun, labelKey: "sidebar.dailyRoutines", path: "/daily-routines", group: "ai" },
];
