        ...
        <div className="px-6 pb-6">
          ...
          {step === 1 && (
            <div className="text-center pt-4">
              ...
              <p className="text-zinc-400 text-sm mb-6 max-w-md mx-auto">
                Let's get you set up in under 2 minutes. ONYX OS will help you generate qualified B2B leads, enrich them with AI, and automate your outreach.
              </p>
            ...
            <div className="pt-2">
              <div className="mb-5">
                ...
                <p className="text-zinc-400 text-sm">
                  This helps ONYX OS generate leads that match your exact target profile.
                </p>
              </div>
          ...
          {step === 4 && (
            <div className="text-center pt-4">
              ...
              <p className="text-zinc-400 text-sm mb-6 max-w-md mx-auto">
                Your ICP is saved and ONYX OS is ready to generate your first batch of qualified leads. Let's go!
              </p>
